...
string GetSetGearError(int gear)
{
	string error;
	error.append("Can not set gear ")
		.append(to_string(gear))
		.append("!");
	return error;
}

string GetSetSpeedError(int gear)
{
...
BOOST_AUTO_TEST_CASE(can_not_engine_on)
{
...
{
	BOOST_CHECK(car.SetGear(0));
	CarStatesCheck(car, true, 0, 20, Direction::backward, blankString);
}
...
BOOST_AUTO_TEST_CASE(can_not_speed_up_in_neutral_gear)
{
	...
	CarStatesCheck(car, true, 0, 20, Direction::backward, blankString);
	BOOST_CHECK(car.SetSpeed(10));
	CarStatesCheck(car, true, 0, 10, Direction::backward, blankString);
...
{
	BOOST_CHECK(car.SetGear(0));
	CarStatesCheck(car, true, 0, 50, Direction::forward, blankString);
}
BOOST_AUTO_TEST_SUITE_END()
//#########################
...
{
	BOOST_CHECK(car.SetGear(0));
	CarStatesCheck(car, true, 0, 60, Direction::forward, blankString);
}
BOOST_AUTO_TEST_SUITE_END()
//#########################
...
{
	BOOST_CHECK(car.SetGear(0));
	CarStatesCheck(car, true, 0, 90, Direction::forward, blankString);
}
BOOST_AUTO_TEST_SUITE_END()
//#########################
...
{
	BOOST_CHECK(car.SetGear(0));
	CarStatesCheck(car, true, 0, 150, Direction::forward, blankString);
}
