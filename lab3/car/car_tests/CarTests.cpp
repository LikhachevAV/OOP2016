...
BOOST_FIXTURE_TEST_SUITE(When_direction_is_forward_and_speedis_not_0, TurnedOnEngineCarWithSpeed30OnFirstGear)
	BOOST_AUTO_TEST_SUITE(SetSpeed_function)
		BOOST_AUTO_TEST_CASE(can_not_set_rewerse_gear)
		{
		...
		BOOST_AUTO_TEST_CASE(switch_direction_to_STOP_if_speed_value_0)
		{
